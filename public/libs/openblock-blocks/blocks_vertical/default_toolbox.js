...
'<category name="%{BKY_MOTORS}" id="motors" colour="#4C97FF" secondaryColour="#3373CC">' +
'<block type="motor_turnfordirection" id="motor_turnfordirection">' +
'<value name="WORD">' +
    '<shadow type="motor_turnfordirection_word">' +
    '</shadow>' +
  '</value>' +
  '<value name="TURN">' +
    '<shadow type="motor_turnfordirection_turn">' +
    '</shadow>' +
  '</value>' +
  '<value name="CIRCLE">' +
  ...
  '</value>' +
  '<value name="TO">' +
  '<shadow type="motor_turnfordirection_to">' +
  '</shadow>' +
'</value>' +
'</block>' +
