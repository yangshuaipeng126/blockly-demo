...
// 整数
Blockly.Blocks['control_whole_num'] = {
  /**
  ...
  init: function () {
    this.appendDummyInput()
      .appendField(new Blockly.FieldInputNumber(1,0, undefined, 1),
        'TIMES');
    this.setOutput(true);
    this.setColour('#fff',
...
Blockly.Blocks['control_positive_num'] = {
  /**
   * Block for motor speed drop-down (used for shadow).
   * @this Blockly.Block
   */
  ...
  init: function() {
    this.jsonInit({
      ...
      "args0": [
        {
          "type": "field_image",
          "src": Blockly.mainWorkspace.options.pathToMedia + "icons/ControlStop.svg",
          "width": 40,
          "height": 40,
          "alt": "Stop"
        }
  ...
  init: function() {
    this.jsonInit({
      ...
      "args0": [
        {
          "type": "field_image",
          "src": Blockly.mainWorkspace.options.pathToMedia + "icons/control_wait_lego.svg",
          "width": 40,
          "height": 40,
          "alt": "Wait"
        },
