      ...
      args0: [
        {
          ...
          name: "WORD",
          options: [
            [Blockly.Msg.MOTOR_TURNFORDIRECTION_WORD_A, "_mouse_"],
          ],
        },
      ],
...
Blockly.Blocks["motor_turnfordirection_turn"] = {
  /**
   * Glide to drop-down menu
   * @this Blockly.Block
   */
      ...
      args0: [
        {
          ...
          name: "TURN",
          options: [
            [`${Blockly.mainWorkspace.options.pathToMedia}rotate-left.svg`, "_mouse_"],
            [Blockly.mainWorkspace.options.pathToMedia + "rotate-right.svg", "_random_"],
          ],
        },
      ],
      colour: Blockly.Colours.motors.secondary,
      ...
      args0: [
        {
          ...
          options: [
            ...
            [Blockly.Msg.MOTOR_TURNFORDIRECTION_TO_SECONDS, "_random_"],
          ],
        },
      ],
      colour: Blockly.Colours.motors.secondary,
...
Blockly.Blocks["motorGoDirectionToPosition"] = {
  /**
   * Block to turn right.
   * @this Blockly.Block
   */
